...
{
  question: "2. Which of the following is required by K-means clustering?",
  answers: {
...
{
  question: "3.Point out the wrong statement.",  ///// Write the question inside double quotes
  answers: {
...
{
  question: "4.K-Means is which type of learning algorithm?",  ///// Write the question inside double quotes
  answers: {
    a: "Supervised",
    b: "Unsupervised",
    c: "Reinforcement",
...
{
  question: "5.In K-Means, K stands for ",  ///// Write the question inside double quotes
  answers: {
    a: "Data sets",
    b: "Number of clusters",
    c: "Error functions",
